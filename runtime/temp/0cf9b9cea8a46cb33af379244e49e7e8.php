...
<div class='php-search-header'>
    <div class="layui-main">
        <div class="layui-input-block">
            ...
            <form action="<?php echo url('@blog/search'); ?>" method="get" target="_self">
...
<div class="layui-main" style="min-height: 500px;">
    <div class="layui-row php-search">
        <div class='nav-sel'>
            <ul>
                <li <?php if(empty(app('request')->get('category_id'))): ?>class='on'<?php endif; ?>> <a href="<?php echo url('@blog/search'); ?>?word=<?php echo htmlentities((app('request')->get('word') ?: '')); ?>">全站</a></li>
                <?php foreach($category_list as $vo): ?>
                <li <?php if(app('request')->get('category_id')==$vo['id']): ?>class='on'<?php endif; ?>><a href="<?php echo url('@blog/search'); ?>?category_id=<?php echo htmlentities((isset($vo['id']) && ($vo['id'] !== '')?$vo['id']:'')); ?>&word=<?php echo htmlentities((app('request')->get('word') ?: '')); ?>"><?php echo htmlentities((isset($vo['title']) && ($vo['title'] !== '')?$vo['title']:'')); ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
