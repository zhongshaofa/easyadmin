<?php /*a:2:{s:59:"/var/www/html/EasyAdmin/app/admin/view/system/menu/add.html";i:1573130136;s:57:"/var/www/html/EasyAdmin/app/admin/view/Public/iframe.html";i:1573372826;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layuimini-main">
        ...
        <form id="app-form" class="layui-form layuimini-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="href" class="layui-input" lay-reqtext="请输入菜单链接" placeholder="请输入菜单链接" value="">
                    <tip>填写菜单链接。</tip>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="icon" name="icon" lay-filter="icon" class="hide" value="fa-list">
                </div>
            </div>
