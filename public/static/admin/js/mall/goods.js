        ...
        index: function () {
            ea.table.render({
                ...
                cols: [[
                    ...
                    {field: 'market_price', width: 80, title: '市场价', edit: 'text', align: "center"},
                    {field: 'discount_price', width: 80, title: '折扣价', edit: 'text', align: "center"},
                    {field: 'sales', width: 80, title: '销量', edit: 'text', align: "center"},
                    {field: 'stock', width: 80, title: '库存', edit: 'text', align: "center"},
